...
public class AccountService implements IAccountService{
    ...
    @Override
    public  boolean transfer(String fromAccountNumber, String toAccountNumber, BigDecimal amount) throws SQLException {
        if (!service.isLoggedIn()) {
            throw new UserNotLoggedInException();
        }
        ...
        accountDao.updateAccountBalanceTransfer(fromAccountNumber,toAccountNumber,amount);
