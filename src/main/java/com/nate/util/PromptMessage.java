...
public class PromptMessage {
    ...
    private ScannerError scannerErr;
    public PromptMessage(ScannerError scanner){
        this.scannerErr = scanner;
    }

    // Prompts the user for a BigDecimal input and validates it
    public BigDecimal promptBigDec(String message){
      BigDecimal input;
        while(true){
            System.out.print(message);
            try{
               input = scannerErr.scanner.nextBigDecimal();
               scannerErr.scanner.nextLine();
               break;
            }
    ...
    public String promptString(String message){
        ...
        while(true){
            ...
            input = scannerErr.scanner.nextLine();
            if(input.isBlank()){
    ...
    public String promptInt(String message){
        String input;
    ...
    // Prompts the user for a 10-digit account number as a String
    public String promptIntRec(String message){
        String input;
