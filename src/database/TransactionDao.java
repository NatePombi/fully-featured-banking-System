...
public class TransactionDao implements ITransactionDao{
    ...
    @Override
    public void saveTransaction(ITransactions tx ) throws SQLException {
        ...
        try(Connection con = dbFunction.getConnection();
                PreparedStatement stm = con.prepareStatement(save)){
    ...
    @Override
    public List<ITransactions> getTransactionsByAccountNumber(String accountNumber){
